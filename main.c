...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/08/09 14:31:22 by rgomes-g          #+#    #+#             */
/*   Updated: 2025/08/09 17:43:53 by rgomes-g         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	printf("%d\n", x);
	x = printf("%c %s %d %i %u %p %p %x %X %x %X 100%%", 'a', "Rafaela", 22, 42, 294967295, &x, (void *)0, 255, 255, -255, -255);
	printf("%d\n", x);
	x = ft_printf("%c %s %d %i %u %p %p %x %X %x %X 100%%", 'a', "Rafaela", 22, 42, 294967295, &x, (void *)0, 255, 255, -255, -255);
	ft_printf("%d\n", x);
	printf("%z\n");
	ft_printf("%z\n");
	printf(NULL);
